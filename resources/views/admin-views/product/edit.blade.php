...
<div class="content container-fluid mt--8">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="product-form" action="{{route('admin.updateProduct',$product->id)}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mt-2">
                            ...
                            <input type="number" min="0" value={{
                                $product->discount_type=='flat'?($product->discount):
                            $product->discount}} step="0.01"
                            placeholder="{{('Discount') }}" name="discount"
                            class="form-control" required>
                        </div>
                        <div class="col-md-2 mt-2" style="padding-top: 30px;">
                            <select class="form-select form-control" style="width: 100%"
                        ...
                        <div class="col-md-6 mt-2" id="quantity">
            ...
            <div class="card-body">
                <div class="row">
                    {{-- <div class="col-md-12 mb-4">
                        ...
                        <small class="badge badge-soft-danger"> ( {{('optional, please provide embed
                            link not direct link')}}. )</small>
...
<script>
    function check() {
            ...
            $.post({
                url: '{{route('admin.updateProduct',$product->id)}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
