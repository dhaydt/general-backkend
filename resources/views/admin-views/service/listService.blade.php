...
@section('content')
@include('admin-views.service.partials._headerList')
<style>
    .viewUser {
        font-size: 18px;
        color: #5e72e4;
...
<div class="container-fluid mt--8">
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr class="text-center">
                                ...
                                <th scope="col" class="sort" data-sort="budget">Service name</th>
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                {{-- <td class="text-center">
                                    <span class="badge badge-dot mr-4">
                                        <i class="bg-warning"></i>
                                        <span class="status">{{ $ad['details'] }}</span>
                                    </span>
                                </td> --}}
                                <td class="text-center">
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-around">
                                        ...
                                        <a href="{{ route('admin.editService', ['id' => $ad['id']]) }}"
                                            class="viewUser text-green" data-toggle="tooltip" data-placement="top" title="edit">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <a href="{{ route('admin.deleteService', ['id' => $ad['id']]) }}"
    ...
    $(document).on('change', '.status', function () {
        ...
        $.ajax({
            url: "{{route('admin.updateServiceStatus')}}",
            method: 'POST',
            data: {
                id: id,
                status: status
